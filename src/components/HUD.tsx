  ...
  return (
    <header className="flex items-center justify-between w-full px-3 py-2 border-b border-gray-200 dark:border-gray-700">
      ...
      <button
        ...
        className="w-12 h-12 flex items-center justify-center rounded hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400"
      >
